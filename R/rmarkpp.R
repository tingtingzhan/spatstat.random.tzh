...
rmarkpp <- function(
  ...
  fn <- if (length(par) == 2L) {
    ...
    message(sprintf(fmt = 'Point-pattern generated by %s', col_blue(addNamespace(getAnywhere(rfn[[1L]])))))
    message(sprintf(fmt = 'Marks generated by %s', col_magenta(addNamespace(getAnywhere(rfn[[2L]])))))
